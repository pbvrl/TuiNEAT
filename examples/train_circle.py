...
if __name__ == "__main__":
    config = parse_args()
    train_task = Circle(test=False, max_steps=config.max_rollout_steps)
    test_task = Circle(test=True, max_steps=config.max_rollout_steps)
    ...
    img = Circle.render(task_state, action)
