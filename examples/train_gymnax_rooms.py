# In this task the agent has the goal coordinates;
# The objective is to develop a policy that knows the map geometry
...
GYMNAX_ENV = "FourRooms-misc"
INPUT_NAMES = ["agent_y", "agent_x", "goal_y", "goal_x"]
OUTPUT_NAMES = ["up", "right", "down", "left"]
LOG_DIR = "log/gymnax/FourRooms"
LOGGER_NAME = "FourRooms"
...
if __name__ == "__main__":
    ...
    train_task = GymnaxTask(
        ...
        test=False,
        restart_on_done_mid_rollout=True,
